      ...
      <div className={styles.page}>
        <LegalDocument title="GDPR & EU/UK data protection information" lastUpdated={UPDATED}>
          ...
          <p>
            ...
            <Link href="/privacy">Privacy Policy</Link> with practical detail for individuals in
            those regions. It is <strong>not</strong> a substitute for the full legal texts or for
          ...
          <ul>
            ...
            <li>
              <strong>Accuracy</strong> — we correct data when informed of errors when
              proportionate.
            </li>
            <li>
              <strong>Storage limitation</strong> — we retain data only as long as needed (see
              Privacy Policy).
            </li>
            <li>
              <strong>Integrity and confidentiality</strong> — we apply security measures
              appropriate to risk.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <strong>Legitimate interests</strong> (Article 6(1)(f)) — for example network
              security, fraud prevention, service improvement, and limited internal reporting,
              balanced against your rights; you may object where applicable.
            </li>
            <li>
              <strong>Consent</strong> (Article 6(1)(a)) — for optional cookies, certain marketing,
              or other processing where consent is the appropriate basis.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <strong>Erasure (“right to be forgotten”)</strong> (Article 17) — request deletion
              where grounds apply.
            </li>
            <li>
            ...
            <li>
              <strong>Withdraw consent</strong> at any time where processing is consent-based,
          ...
          <p>
            When personal data leaves the EEA, UK, or Switzerland, we use appropriate safeguards
            such as Standard Contractual Clauses (Commission Implementing Decision 2021/914), the UK
          ...
          <p>
            ...
            or return data at end of service, and demonstrate compliance. A current list of
            categories of processors is available on request to enterprise customers;
            consumer-facing detail may be summarised in the Privacy Policy.
          </p>
          ...
          <LegalNote>
            ...
            could adjust certain procedural aspects (for example centralised breach reporting
            concepts and thresholds). Until final text and implementation, we follow existing GDPR
            Articles 33–34 and regulatory guidance from the EDPB.
          </LegalNote>
          ...
          <p>
            ...
            Supervisor have issued public reactions flagging that some draft GDPR-facing changes
            could affect the level of protection and should be assessed carefully as texts evolve.
          </p>
          <p>
          ...
          <LegalNote>
            ...
            <strong>not</strong> final and uniformly applicable EU law for MegDB processing unless
            and until adopted, published in the <em>Official Journal of the European Union</em>, and
            in force. Until then, this page remains grounded in the GDPR and UK GDPR as currently
            applicable. We revise these documents when binding rules change.
          </LegalNote>

          <h2 id="uk">11. United Kingdom</h2>
          <p>
            After Brexit, the UK GDPR and Data Protection Act 2018 form the core UK framework. The
            UK adequacy decision from the EU (2021) remains a reference for EU-to-UK flows, subject
            to periodic review. UK-specific cookie and electronic marketing rules implement PECR;
