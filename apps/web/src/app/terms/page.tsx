    ...
    <>
      ...
      <div className={styles.page}>
        <LegalDocument title="Terms of Service" lastUpdated={UPDATED}>
          ...
          <p>
            If you are using the Services on behalf of a company or other legal entity, you
            represent that you have authority to bind that entity, in which case “you” includes the
            entity.
          </p>

          <h2 id="changes">2. Changes</h2>
          <p>
            We may modify the Services or these Terms to reflect new features, legal requirements,
            or security needs. We will post the updated Terms on this page and update the “Last
            updated” date. For material changes, we may provide additional notice where appropriate.
          ...
          <p>
            ...
            requires a higher minimum age for certain features (for example account registration),
            you must meet that age. The Services are not intended for children under the age
            required in your region to consent to online data processing without parental
            permission.
          </p>
          ...
          <p>
            ...
            stated, MegDB does not stream full titles inside the player as a licensed
            video-on-demand retailer; primary audiovisual content may be hosted by third parties
            when you follow outbound links or embeds.
          </p>
          ...
          <p>
            ...
            and attribution requirements. You agree not to use MegDB in any way that would cause us
            to violate TMDB’s rules, including excessive automated scraping beyond what our
            technical measures permit.
          </p>
          <p>
          ...
          <ul>
            <li>
              Violate applicable laws, third-party rights (including copyright and trade mark
              rights), or industry rules.
            </li>
            <li>
              Attempt to probe, scan, or test the vulnerability of our systems; breach
              authentication; or bypass rate limits, robots rules, or access controls.
            </li>
            <li>
          ...
          <p>
            If we allow you to submit reviews, comments, lists, or other content (“User Content”),
            you retain ownership of your intellectual property rights in that content, but you grant
            MegDB a worldwide, non-exclusive, royalty-free licence to host, store, reproduce, modify
            (for formatting), display, and distribute User Content solely to operate, promote, and
            improve the Services. You represent that you have all rights necessary to grant this
            licence and that User Content does not infringe third-party rights.
          </p>
          <p>
          ...
          <p>
            ...
            TO THE SERVICES IN ANY TWELVE-MONTH PERIOD WILL NOT EXCEED THE GREATER OF (A) ONE
            HUNDRED U.S. DOLLARS (US$100) OR (B) THE AMOUNTS YOU PAID TO MEGDB FOR THE SERVICES IN
            THAT PERIOD (IF ANY). SOME JURISDICTIONS DO NOT ALLOW CERTAIN LIMITATIONS; IN THOSE
          ...
          <p>
            ...
            arising out of your User Content, your misuse of the Services, or your violation of
          ...
          <p>
            ...
            parties. Provisions that by their nature should survive (including intellectual
            property, disclaimers, limitation of liability, indemnity, and governing law) will
            survive termination.
          </p>
          ...
          <p>
            ...
            Courts in that jurisdiction will have exclusive venue, subject to non-waivable rights
            you may have as a consumer to sue in your home courts.
          </p>
          <LegalNote>
          ...
          <p>
            ...
            is held invalid, the remainder remains enforceable. Our failure to enforce a provision
            is not a waiver. You may not assign these Terms without our consent; we may assign them
