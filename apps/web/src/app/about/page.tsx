    ...
    <>
      ...
      <div className={styles.page}>
        ...
        <LegalDocument title="About MegDB" lastUpdated={UPDATED}>
          ...
          <p>
            MegDB helps people decide <strong>what to watch next</strong> by surfacing
            well-structured discovery experiences: curated home rails, genre and studio exploration,
            fast search, and detail pages where implemented. We prioritise clarity, performance, and
            respect for rights holders’ and users’ expectations in 2026’s regulatory environment
            (privacy, accessibility, and fair API use).
          </p>
          ...
          <ul>
            <li>
              We are <strong>not</strong> a streaming host — we do not provide licensed playback as
              a primary service.
            </li>
            <li>
            ...
            <li>
              We are <strong>not</strong> a paywalled critics’ publication — commentary is minimal
              and functional.
            </li>
          </ul>
          ...
          <p>
            ...
            TypeScript, and CSS modules aligned to a compact design-token system. Data is fetched
            from TMDB over HTTPS with caching tuned per surface (for example faster refresh for
            trending, slower for stable charts). Rate limiting protects shared infrastructure on
            search and discover API routes.
          </p>
          <LegalNote>
            ...
            AI-adjacent regulation on our <Link href="/privacy">Privacy Policy</Link> where
            relevant.
          </LegalNote>
          ...
          <p>
            Thanks to TMDB contributors worldwide for maintaining an indispensable open catalogue,
            and to users who file thoughtful bug reports. Built with care for keyboard users,
