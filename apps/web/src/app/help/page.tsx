      ...
      <div className={styles.page}>
        <LegalDocument title="Help &amp; Support" lastUpdated={UPDATED}>
          ...
          <p>
            ...
            Movie Database (TMDB). MegDB does not replace your streaming provider — check each
            title’s availability in your region on licensed platforms.
          </p>
          <ul>
            <li>
            ...
            <li>
              <strong>Search</strong> — type at least two characters in the header; choose a result
              or open the <Link href="/search">full search page</Link> with <code>?q=</code> in the
              URL.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              Try shorter fragments if a long title fails (for example the unique part of a
              franchise name).
            </li>
            <li>
              People search returns actors and crew; open a person card to see known-for context
              when available.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              If our site displays stale data after TMDB fixed it, try a hard refresh; caching
              windows vary by route (see our engineering docs or <Link href="/about">About</Link>).
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            disable conflicting extensions temporarily, and try another network to rule out
            corporate blocking.
          </p>
          <p>
            Lost access: use your provider’s password reset (email, OAuth, etc.). MegDB support
            cannot bypass your identity provider’s security checks.
          </p>
          ...
          <p>
            For how we handle personal data, cookies, GDPR-related information, and U.S. state
            rights, read our <Link href="/privacy">Privacy Policy</Link>,{' '}
          ...
          <p>
            Report security vulnerabilities to <strong>security@megdb.com</strong> (if published)
            with encrypted detail if needed. Do not perform destructive testing without permission.
          </p>
          <p>
          ...
          <p>
            ...
            <Link href="/contact">Contact</Link> with a clear subject line — we prioritise
            good-faith technical reports and business development separately from consumer support.
          </p>
          ...
          <p>
            ...
            privacy signals (such as Global Privacy Control in several U.S. states), and
            accessibility expectations tied to WCAG 2.2-level guidance in many procurement and
            regulatory contexts. MegDB iterates on these themes as the stack matures — see{' '}
            <Link href="/accessibility">Accessibility</Link> for our conformance statement
            direction.
          </p>

          <h2 id="still-stuck">10. Still stuck?</h2>
          <p>
            Email <strong>support@megdb.com</strong> with screenshots, your browser version, and
            steps to reproduce. We cannot guarantee individual response SLAs for free-tier users,
            but we read every good-faith report.
          </p>
          <p>
