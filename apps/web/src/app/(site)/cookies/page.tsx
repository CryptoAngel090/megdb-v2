      ...
      <div className={styles.page}>
        <LegalDocument title="Cookie Policy" lastUpdated={UPDATED}>
          ...
          <p>
            ...
            that store or access information on your device when you visit our website or use our
            web applications. It should be read together with our{' '}
            <Link href="/privacy">Privacy Policy</Link>.
          </p>
          <p>
            Regulators increasingly refer to <strong>storage and access technologies</strong>{' '}
            broadly — not only classic HTTP cookies but also pixels, scripts that set identifiers,
            browser storage APIs, and fingerprinting-like signals. Where this policy says “cookies”,
            it includes those comparable technologies unless we specify otherwise.
          </p>
          ...
          <p>
            In the European Economic Area, United Kingdom, and several other jurisdictions, storing
            or accessing information on a user’s terminal equipment generally requires a lawful
            basis. For non-essential technologies (most analytics, advertising, and many
            personalisation tools), regulators typically expect{' '}
            <strong>prior, informed consent</strong> that is freely given, specific, informed, and
            unambiguous — not pre-ticked boxes or “bundled” consent that hides granular choices.
          </p>
          <p>
          ...
          <p>
            ...
            measurement are <strong>not</strong> strictly necessary merely because they “improve”
            the product; those purposes typically require consent in the UK/EEA model unless another
          ...
          <p>
            ...
            their privacy notices. We seek to load non-essential third parties only after consent
            and to use data-processing terms where we act as a controller jointly or as a processor
          ...
          <p>
            ...
            <strong>opt-out preference signals</strong> as legally recognised ways to exercise
            opt-out rights (for example for “sale” or “sharing” of personal information for
            cross-context behavioural advertising), sometimes referred to under frameworks like the{' '}
            <strong>Global Privacy Control (GPC)</strong>. Requirements vary by statute and
            regulator guidance.
          </p>
          <p>
            Where MegDB is subject to such a requirement and your browser transmits a valid signal
            we are configured to honour, we will process it in line with applicable law. This does
            not automatically override EU/UK consent rules where stricter standards apply. For a
            fuller view of U.S. rights, see the U.S. section of our{' '}
            <Link href="/privacy">Privacy Policy</Link>.
          </p>
          ...
          <p>
            ...
            attributes ranging from days to months depending on purpose — for example consent
            records may be kept long enough to prove compliance. We review retention periodically.
          </p>
          ...
          <p>
            ...
            “Digital Omnibus” — aimed at simplifying overlapping digital rules. Among ideas
            discussed in institutional debate are modernising cookie consent mechanics (for example
            reducing “consent fatigue” through clearer defaults and browser-level tools) and
            clarifying how certain rules interact with the GDPR.
          </p>
          <LegalNote>
            As of April 2026, many Omnibus items remain subject to the ordinary EU legislative
            process (Parliament and Council positions, possible amendments). Until adopted and in
            force, the ePrivacy Directive (and national implementing laws) plus the GDPR remain the
            key references for most EU users. The European Data Protection Board and European Data
            Protection Supervisor have highlighted concerns on specific GDPR amendment ideas;
            outcomes may change before final texts apply.
          </LegalNote>
