    ...
    <>
      ...
      <div className={styles.page}>
        <LegalDocument title="Digital Millennium Copyright Act (DMCA) policy" lastUpdated={UPDATED}>
          ...
          <p>
            MegDB primarily displays catalogue metadata, posters, and related materials sourced
            under licence from third-party databases (for example TMDB). If you believe{' '}
          ...
          <p>
            DMCA notices must be sent to our designated copyright agent. Until a U.S. Copyright
            Office registration number is published on this page, use:
          </p>
          <ul>
            <li>
          ...
          <ol>
            ...
            <li>
              ...
              and information reasonably sufficient to permit MegDB to locate the material (for
              example exact URL paths, user account, or timestamped screenshots).
            </li>
            <li>
              Information reasonably sufficient to contact you, such as an address, telephone
              number, and email.
            </li>
            <li>
          ...
          <p>
            ...
            and provide a copy of the notice (with personal data redacted where sensible) so they
            can file a counter-notice if permitted.
          </p>
          <p>
          ...
          <p>
            Upon receipt of a valid counter-notice, we may forward it to the original complainant.
            The complainant may have a limited window to seek a court order; if no order is
            obtained, we may restore the material at our discretion under § 512(g).
          </p>
          ...
          <p>
            ...
            including costs and attorneys’ fees. Submit notices in good faith and with accurate
            facts.
          </p>
          ...
          <p>
            ...
            requests where legally compelled or where they provide sufficient detail under
          ...
          <LegalNote>
            As of April 2026, core § 512 notice-and-takedown rules remain the governing U.S.
            framework for qualifying online service providers. We monitor statutory and case-law
            developments and will update this policy if legal requirements change materially.
          </LegalNote>
