    ...
    <>
      ...
      <div className={styles.page}>
        ...
        <p className={styles.scopeNote}>
          Витрина компонентов <code>@repo/ui</code> (как в админке). Основной сайт MegDB опирается
          на глобальные токены в <code>apps/web/src/styles/globals.css</code> — значения могут
