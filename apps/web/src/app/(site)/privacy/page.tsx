        ...
        <LegalDocument title="Privacy Policy" lastUpdated={UPDATED}>
          ...
          <ul>
            <li>
              ...
              from IP, browser type and version, operating system, language preferences, referrer
              URL, and date/time of requests.
            </li>
            <li>
            ...
            <li>
              <strong>Product analytics (if enabled):</strong> aggregated or pseudonymous
              information about feature usage, scroll depth, or performance metrics. Where required
              by law, we will ask for your consent before using non-essential analytics or
          ...
          <ul>
            ...
            <li>
              ...
              reliability, understanding aggregated usage, and preventing abuse, balanced against
              your rights.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <strong>Analytics or error-reporting vendors</strong> if we enable them, generally
              under data-processing terms and, where required, your consent.
            </li>
            <li>
            ...
            <li>
              <strong>Authorities</strong> when we believe disclosure is required by law or to
          ...
          <p>
            ...
            qualifies as a sale or “sharing” for cross-context behavioural advertising, we will
            update this policy and provide any required controls.
          </p>
          ...
          <p>
            ...
            authority, we will use appropriate safeguards such as Standard Contractual Clauses
            (SCCs), UK Addendum, or other mechanisms recognised at the time of transfer, plus
            supplementary measures where required by case law and regulatory guidance.
          </p>
          ...
          <ul>
            <li>
              <strong>Security logs:</strong> typically rotated within a limited window unless
              longer retention is needed to investigate an incident.
            </li>
            <li>
              <strong>Account data:</strong> retained while your account is active and for a grace
              period afterward unless you ask for earlier deletion, subject to exceptions (for
              example billing records).
            </li>
            <li>
              <strong>Support tickets:</strong> retained long enough to resolve issues and
              demonstrate good-faith handling of disputes.
            </li>
          </ul>
          ...
          <p>
            To exercise rights, contact <strong>privacy@megdb.com</strong>. We may need to verify
            your identity before fulfilling requests. If you are in the EEA/UK, see also{' '}
          ...
          <p>
            ...
            changes) staged later in the year. Because thresholds, definitions, and enforcement
            differ by statute, you should review the law that applies to your residence.
          </p>
          <p>Depending on your state, you may have the right to:</p>
          <ul>
            <li>
              <strong>Know / access</strong> personal information we hold and how we use and
              disclose it.
            </li>
            <li>
            ...
            <li>
              Use an <strong>authorised agent</strong> in some states, with proof you authorised
              them.
            </li>
          </ul>
          <p>
            We will not discriminate against you for exercising privacy rights where that
            prohibition applies. Some browsers support a global privacy control (GPC) or similar
            signal; where a state law requires us to treat an opt-out signal as a valid request, we
            will implement that requirement. See also our <Link href="/cookies">Cookie Policy</Link>{' '}
            for storage technologies and consent.
          </p>
          <LegalNote>
            State laws and regulatory guidance change frequently. The summary above is not a
            50-state matrix. If you need the exact effective date or scope for your state, consult
            your Attorney General’s consumer resources or qualified counsel.
          </LegalNote>

          <h2 id="children">12. Children</h2>
          <p>
            MegDB is not directed at children under 16 (or the age required in your jurisdiction).
          ...
          <p>
            ...
            catalogue metadata and general popularity or editorial rules, not on individual
            profiling that would deny you essential services.
          </p>
          <LegalNote>
          ...
          <LegalNote>
            ...
            adjustments). Unless and until adopted, the GDPR (EU) 2016/679 and related ePrivacy
            rules remain the primary framework for many EU users. We monitor legislative
            developments and will adjust this policy when final rules apply to our processing.
          </LegalNote>
