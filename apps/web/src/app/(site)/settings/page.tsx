    ...
    <>
      ...
      <div className={styles.page}>
        <LegalDocument title="Settings" lastUpdated={UPDATED}>
          ...
          <p>
            This page collects the main controls and policies that affect your MegDB experience.
            Some toggles live inside the product UI when you are signed in; others are managed
            through your browser or operating system. We are expanding account-level settings as
            authentication and profiles mature.
          </p>
          ...
          <ul>
            ...
            <li>
              <Link href="/watchlist">Watchlist</Link> — saved titles; export or delete may be
              offered as GDPR tooling lands.
            </li>
            <li>
          ...
          <p>
            To change the email on your account or delete the account entirely, use in-app flows
            when available or email <strong>privacy@megdb.com</strong> with the subject line{' '}
          ...
          <p>
            <strong>Data subject requests:</strong> email <strong>privacy@megdb.com</strong> from
            the address you used to register (or describe your account identifiers). We verify
            ownership before exporting or deleting data where required by law.
          </p>
          <LegalNote>
            U.S. residents: many states now provide opt-out, access, deletion, correction, and
            appeal rights — see the U.S. section of our Privacy Policy. Browser signals such as GPC
            may be honoured where legally required.
          </LegalNote>

          <h2 id="display">4. Display, language, and motion</h2>
          <p>
            <strong>Theme:</strong> MegDB uses a dark-first interface aligned with its design
            system. If we ship explicit light/high-contrast themes, they will appear here or in the
            header menu.
          </p>
          <p>
            <strong>Language:</strong> the interface is English-first in 2026; additional locales
            may roll out with TMDB language parameters for metadata. Your browser’s language header
            may influence auxiliary content where supported.
          </p>
          <p>
            ...
            Motion or CSS transitions should respect <code>prefers-reduced-motion: reduce</code>{' '}
            where implemented — report gaps via <Link href="/accessibility">Accessibility</Link>.
          </p>

          <h2 id="search-behavior">5. Search &amp; browse defaults</h2>
          <p>
            Default catalogue language for TMDB-backed API calls may follow product configuration
            (for example regional locale). If titles appear in an unexpected language, check TMDB’s
          ...
          <p>
            <strong>Delete account:</strong> when self-service deletion ships, you will find it
            under Profile or here. Until then, email <strong>privacy@megdb.com</strong> with “Delete
            my account” and your registered email. Some billing or fraud-prevention records may be
