      ...
      <div className={styles.page}>
        <LegalDocument title="Contact MegDB" lastUpdated={UPDATED}>
          ...
          <p>
            ...
            business name and address of the MegDB operator here once finalised. Until then,
            initiate contact through <a href="mailto:legal@megdb.com">legal@megdb.com</a> for the
          ...
          <p>
            MegDB staff will not ask for your password, one-time codes, or crypto transfers by
            email. Report impersonation to{' '}
            <a href="mailto:security@megdb.com">security@megdb.com</a>. In 2026 phishing continues
            to spike around entertainment brands — inspect domains carefully.
          </p>

          <h2 id="eu-rep">6. EU / UK representatives</h2>
          <p>
            If we appoint an EU Article 27 representative or UK representative, their name and
            contact details will appear in the <Link href="/privacy">Privacy Policy</Link> and here.
            As of this revision, check the policy header for the latest entry.
          </p>
