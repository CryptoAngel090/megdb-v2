    ...
    <>
      ...
      <div className={styles.page}>
        <LegalDocument title="Accessibility" lastUpdated={UPDATED}>
          ...
          <p>
            MegDB is committed to making its web experience perceivable, operable, understandable,
            and robust for people with disabilities. We use the Web Content Accessibility Guidelines
          ...
          <p>
            ...
            including, at Level AA, requirements such as{' '}
            <strong>Focus Not Obscured (Minimum)</strong> (2.4.11),{' '}
            <strong>Dragging Movements</strong> (2.5.7), and <strong>Target Size (Minimum)</strong>{' '}
            (2.5.8). These criteria matter for keyboard users, people with motor impairments, and
            anyone using zoomed or small screens.
          </p>
          <p>
          ...
          <p>
            ...
            supervising compliance. Harmonised standard <strong>EN 301 549</strong> (which
            references WCAG for ICT) is commonly used to demonstrate technical alignment for covered
          ...
          <ul>
            ...
            <li>
              Third-party embeds (trailers, social widgets) may not meet our internal bar — we
              prefer first-party or configurable embeds.
            </li>
            <li>
          ...
          <p>
            We track accessibility bugs alongside security and privacy. If national law gives you
            the right to escalate to an equality body or market surveillance authority, you may do
