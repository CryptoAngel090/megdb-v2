...
function providerName(state: MoviesDiscoverState, ctx?: MoviesDiscoverCopyContext): string | undefined {
...
function studioName(state: MoviesDiscoverState, ctx?: MoviesDiscoverCopyContext): string | undefined {
